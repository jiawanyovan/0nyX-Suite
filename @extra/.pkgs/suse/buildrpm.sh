...
License: CC-BY-SA_V4
Requires: unzip, curl, findutils, gtk2-engine-mist, bc
Provides: 0nyx-theme = %version, gnome-icon-theme
Obsoletes: phlat, 0nyx-theme <= %version
Recommends: gtk3-nocsd, libgtk-3-0 >= 3.20, hicolor-icon-theme, qt5ct, libqt5-qtsvg, xfwm4, icewm, openbox, xfce4-notifyd, xfdashboard, onboard, audacious, qmmp, slim, albert
